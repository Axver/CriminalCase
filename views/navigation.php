<nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="laporanPolisi.php">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
                    <span class="menu-title">Laporan Polisi</span>
                </a>
            </li>

          <li class="nav-item menu-items">
            <a class="nav-link" href="laporanSTTPLP.php">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="tentangAplikasi.php">
              <span class="menu-icon">
